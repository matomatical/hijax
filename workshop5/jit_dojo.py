...
def lesson1():
    ...
    print(jax.make_jaxpr(f1_nojit)(jnp.arange(8), jnp.ones(8, dtype=int)))
...
def lesson2():
    ...
    result = f2(jnp.arange(8), 2*jnp.ones(8, dtype=int))
    print("   result:", result)
...
def lesson5():
    ...
    # print("3. the loop is unrolled and the etc.")
    # print(jax.make_jaxpr(f5)(jnp.array([1,2,3,4])))
...
def lesson7():
    ...
    print("6. calling function with two trees...")
    result = f7_filterjit(
        n=(min, max),
        a=(sum,),
    )
    ...
    print("7. calling function with another two trees...")
    result = f7_filterjit(
        n=(sum,),
        a=(min, max),
    )
    ...
    print("8. calling function with the same two trees...")
    result = f7_filterjit(
        n=(sum,),
        a=(min, max),
    )
