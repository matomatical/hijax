...
* introducing jax.jit, which functions can/should we decorate?
"""
...
def main(
    ...
    def train_step(key, model, opt_state):
        ...
        return key, model, opt_state, loss
    ...
    for step in range(num_steps):
        key, model, opt_state, loss = train_step(key, model, opt_state)
